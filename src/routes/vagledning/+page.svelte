	...
	<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 min-w-0">
		...
		<div class="bg-amber-50 border border-amber-200 rounded-lg p-4 mb-6">
			<div class="flex items-start">
				...
				<div class="ml-3">
					<h3 class="text-sm font-medium text-amber-800">Vägledning under utveckling</h3>
					<div class="mt-1 text-sm text-amber-700">
						<p>Denna vägledning utvecklas kontinuerligt baserat på användarfeedback och erfarenheter. Innehållet kan komma att uppdateras och förbättras.</p>
					</div>
				</div>
			</div>
		</div>
